 ...
 */
//{{FORM_CLASS_DECL
public class fOrderItem_ORD extends fOrderItem_ORDBase
//END_FORM_CLASS_DECL}}
{

	//{{FORM_CLASS_CTOR
	public fOrderItem_ORD() throws VSException, PropertyVetoException {
	//END_FORM_CLASS_CTOR}}
	}

protected void datT1OrderItem_ORD_BeforeInsert(VSDataControl ctrl, VSRow row, VSOutParam param) {
	// TODO: Complete event handler method body.
pckT1ORD_CurrencyCode.setEditable(false);
pckT1ORD_CurrencyCode.setEnabled(true);
}
