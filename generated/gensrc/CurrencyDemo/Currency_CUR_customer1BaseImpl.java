...
public abstract class Currency_CUR_customer1BaseImpl extends QueryObject {
    public static VersataLogger logger = VersataLogger.getLogger(Currency_CUR_customer1Impl.class);
    
    private static String modelName = "Currency_CUR_customer1";
    ...
    static {
        q = new VSQueryDefinition("Currency_CUR_customer1");
        ...
        VSQueryDefinition qTemp = (VSQueryDefinition)getMetaQuery("Currency_CUR_customer1", "CurrencyDemo");
        if (qTemp == null) {
...
"dbschema>.Currency_CUR Currency_CUR", repositoryName, modelName);
	...
	protected Currency_CUR_customer1BaseImpl(){
		addListeners();
	}
    ...
    public static XDAConnector createXDAConnector() { 
        ...
        try {
            VSMetaTable table = Currency_CUR_customer1BaseImpl.getMetaQuery().getChildMostTable();
            if (table != null)
    ...
    public static XDAConnector createXDAConnector(Session aSession) throws ServerException { 
        ...
        Properties props = ((VSORBSessionImpl)aSession).getMyDataServiceLoginForObject("Currency_CUR_customer1");
    ...
    public XDAConnector getXDAConnector() {
        if (xdac == null)
            xdac = Currency_CUR_customer1BaseImpl.createXDAConnector(session);
        return xdac;
    }
    ...
    public static Enumeration getObjects(SearchRequest searchReq, Session aSession) throws ServerException {
        XDAConnector xdac = Currency_CUR_customer1BaseImpl.createXDAConnector(aSession);
        Connection con = null;
        ...
        ResultSet rs = new VSORBResultSetImpl(Currency_CUR_customer1BaseImpl.getMetaQuery(), searchReq, null, -1, xdac, con);
        DataRow row = null;
