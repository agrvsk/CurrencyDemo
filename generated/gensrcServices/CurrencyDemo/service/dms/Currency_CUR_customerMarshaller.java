...
//	 This is based on the current repository package naming
	import CurrencyDemo.Currency_CUR_customerImpl;
...
/**
	 ...
	 */
	public class Currency_CUR_customerMarshaller implements BusinessObjectMarshaller
	{
		private static final VersataLogger LOGGER = VersataLogger.getLogger(
			Currency_CUR_customerMarshaller.class);
		...
		public void marshal(DataObject dataObject, DataRow dataRow) throws ServerException {
			Currency_CUR_customer currency_CUR_customer = (Currency_CUR_customer)dataObject;
			Currency_CUR_customerImpl currency_CUR_customerImpl = (Currency_CUR_customerImpl)dataRow.getBusinessObject();
			
				
		
		
			currency_CUR_customer.setCUR_Client((java.lang.String)currency_CUR_customerImpl.getValue("CUR_Client"));			
			
		
			currency_CUR_customer.setCUR_CurrencyCode((java.lang.String)currency_CUR_customerImpl.getValue("CUR_CurrencyCode"));			
			
		
			currency_CUR_customer.setCUR_ExchangeRate((java.math.BigDecimal)currency_CUR_customerImpl.getValue("CUR_ExchangeRate"));			
			
		
			currency_CUR_customer.setCUR_NumberOfOrders((Integer)currency_CUR_customerImpl.getValue("CUR_NumberOfOrders"));			
			
		
			currency_CUR_customer.setCUR_OrderValueUSD((java.math.BigDecimal)currency_CUR_customerImpl.getValue("CUR_OrderValueUSD"));			
			
		
			currency_CUR_customer.setCUR_OrderAmountAverage((java.math.BigDecimal)currency_CUR_customerImpl.getValue("CUR_OrderAmountAverage"));			
			
		
			currency_CUR_customer.setCUR_Image((java.lang.String)currency_CUR_customerImpl.getValue("CUR_Image"));			
			
		
			currency_CUR_customer.setCUR_Client_RelatedTo((java.lang.String)currency_CUR_customerImpl.getValue("CUR_Client_RelatedTo"));			
			
		
			currency_CUR_customer.setCUR_CurrencyCode_RelatedTo((java.lang.String)currency_CUR_customerImpl.getValue("CUR_CurrencyCode_RelatedTo"));			
		 ...
		 */
		public void marshal(CurrencyDemo.Currency_CUR_customer sdo, CurrencyDemo.service.dto.Currency_CUR_customerDTO dto) {
		...
		public void unmarshal(DataObject dataObject, DataRow dataRow) throws ServerException {
			...
			currency_CUR_customerImpl.setValue("CUR_Client", currency_CUR_customer.getCUR_Client());
			
		
			currency_CUR_customerImpl.setValue("CUR_CurrencyCode", currency_CUR_customer.getCUR_CurrencyCode());
			
		
			currency_CUR_customerImpl.setValue("CUR_ExchangeRate", currency_CUR_customer.getCUR_ExchangeRate());
			
		
			currency_CUR_customerImpl.setValue("CUR_NumberOfOrders", currency_CUR_customer.getCUR_NumberOfOrders());
			
		
			currency_CUR_customerImpl.setValue("CUR_OrderValueUSD", currency_CUR_customer.getCUR_OrderValueUSD());
			
		
			currency_CUR_customerImpl.setValue("CUR_OrderAmountAverage", currency_CUR_customer.getCUR_OrderAmountAverage());
			
		
			currency_CUR_customerImpl.setValue("CUR_Image", currency_CUR_customer.getCUR_Image());
			
		
			currency_CUR_customerImpl.setValue("CUR_Client_RelatedTo", currency_CUR_customer.getCUR_Client_RelatedTo());
			
		
			currency_CUR_customerImpl.setValue("CUR_CurrencyCode_RelatedTo", currency_CUR_customer.getCUR_CurrencyCode_RelatedTo());
		 ...
		 */
		public void unmarshal(CurrencyDemo.Currency_CUR_customer sdo, CurrencyDemo.service.dto.Currency_CUR_customerDTO dto) throws ServerException {
		...
		public void unmarshal(DataObject dataObject, DataRow dataRow, ChangeSummary changeSummary) throws ServerException {
			...
			for (int j = 0; j < changedList.size(); j++) {
				...
				currency_CUR_customerImpl.setValue(property.getName(), newValue);
			}
		}
		...
		public void unmarshal(DataObject dataObject, DataRow dataRow, Map changedValues) throws ServerException {
			...
			while(iterator.hasNext()){
				...
				currency_CUR_customerImpl.setValue(attribute.getName(), newValue);
			}
		}
	}
