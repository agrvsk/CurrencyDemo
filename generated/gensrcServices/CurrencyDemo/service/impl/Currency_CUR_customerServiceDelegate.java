	...
	/**
	 * The service delegate interface for the Currency_CUR_customerServiceImpl
	 * class.
	 * 
	 ...
	 * delegate class). The generated Currency_CUR_customerServiceImpl code will
	 ...
	 * the object before the Currency_CUR_customerServiceImpl class executes the
	 ...
	 * 
	 * @since 6.0
	 * @see Currency_CUR_customerServiceImpl
	 * 
	 ...
	 */
	 ...
	 public interface Currency_CUR_customerServiceDelegate {	 
		 
		 public boolean beforeGetCurrency_CUR_customerDataGraphByCurrency_CUR_PK1(Object sender, String CUR_Client, String CUR_CurrencyCode, Session session);
		 public boolean afterGetCurrency_CUR_customerDataGraphByCurrency_CUR_PK1(Object sender, DataGraph datagraph, Session session);
		 ...
		 public boolean beforeCrudCurrency_CUR_customerFromDataGraph(Object sender, DataGraph dataGraph, Session session);
		 public boolean afterCrudCurrency_CUR_customerFromDataGraph(Object sender, DataGraph dataGraph, Session session);
		    
		 		 		 
		 public boolean beforeDeleteCurrency_CUR_customer(Object sender,String CUR_Client, String CUR_CurrencyCode, Session session);
		 public boolean afterDeleteCurrency_CUR_customer(Object sender, String CUR_Client, String CUR_CurrencyCode, Session session);		 
	 }
